...
if (isset($_POST['email'])) {
	...
	if ($account) {
		...
		$uniqid = uniqid();
		$stmt = $pdo->prepare('UPDATE accounts SET reset = :uniqid WHERE email = :email');
		...
		$reset_link = 'https://halloweeb.town/password/reset/' . $_POST['email'] . '/' . $uniqid . '/';
		...
		$msg = '<div style="margin:0" class="alert alert-success"><i class="fa fa-check" aria-hidden="true"></i> Reset password link has been sent to your email!</div>';
	} else {
...
<div id="content">
	<div class="wrap">
		<div class="inner_content">
			<h1 class="tag_info">Forgot Password</h1><br>
